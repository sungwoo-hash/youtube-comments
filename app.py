                ...
                with st.spinner("AI가 댓글을 분석하는 중입니다..."):
                    try:
                        ...
                        def analyze_chunk(comments):
                            ...
                            prompt = f"""아래는 유튜브 영상에 달린 댓글 목록입니다. 반드시 한국어로만 작성하세요. 다른 언어는 절대 사용하지 마세요.
...
[감성 분류 기준]
- 긍정: 영상 주제/콘텐츠에 공감, 동의, 지지, 감사, 칭찬을 표현하는 댓글
- 부정: 영상 주제/콘텐츠에 비판, 반박, 불만, 실망, 거부감을 표현하는 댓글
- 중립: 단순 질문, 정보 공유, 개인 경험 나열 등 감성 판단이 어려운 댓글

[주요 키워드 선정 기준]
- 댓글 전체에서 반복적으로 등장하는 핵심 단어 또는 주제
- 조사/접속사/대명사 등 의미 없는 단어는 제외
- 영상 주제와 직접 관련된 명사 또는 개념 중심으로 선정

[주목할 댓글 선정 기준]
- 영상 주제에 대한 핵심 의견이나 대표 감정을 잘 표현한 댓글
- 구체적인 개인 경험이나 사례를 담아 공감을 유발하는 댓글
- 긍정/부정/중립 각 감성을 대표하는 댓글을 균형 있게 선정
